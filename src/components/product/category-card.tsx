...
function CategoryCard({
  ...
  const content = (
    <div
      className={cn(
        'group relative overflow-hidden rounded-xl border bg-card transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-0.5 cursor-pointer',
        className
      )}
      {...props}
    >
      ...
      <div className="p-4">
        ...
        {productCount !== undefined && (
          <p className="text-sm text-muted-foreground mt-0.5">{productCount} products</p>
        )}
      </div>
    </div>
  )
